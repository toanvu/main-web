...
<body>
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation"
		id="head-bar">
		<a class="navbar-brand" href="#"><img src="img/logo.png"></a> <a
			href="#" class="btn btn-danger pull-right">Abmelden</a>
		<ul class="languages pull-right">
			<li>Sprache:</li>
			<li><a href="#" class="tooltip-toggle" data-toggle="tooltip"
				data-placement="bottom" title="Deutsch"><img
					src="img/flag_de.png" alt="Flagge Deutschland"></a></li>
			<li><a href="#" class="tooltip-toggle" data-toggle="tooltip"
				data-placement="bottom" title="Englisch"><img
					src="img/flag_gb.png" alt="Flagge England"></a></li>
			<li><a href="#" class="tooltip-toggle" data-toggle="tooltip"
				data-placement="bottom" title="Französisch"><img
					src="img/flag_hr.png" alt="Flagge Frankreich"></a></li>
			<li><a href="#" class="tooltip-toggle" data-toggle="tooltip"
				data-placement="bottom" title="Italienisch"><img
					src="img/flag_ie.png" alt="Flagge Ireland"></a></li>
			<li><a href="#" class="tooltip-toggle" data-toggle="tooltip"
				data-placement="bottom" title="Spanisch"><img
					src="img/flag_es.png" alt="Flagge Spanien"></a></li>
			<li><a href="#" class="tooltip-toggle" data-toggle="tooltip"
				data-placement="bottom" title="Türkisch"><img
					src="img/flag_tr.png" alt="Flagge Türkei"></a></li>
			<li><a href="#" class="tooltip-toggle" data-toggle="tooltip"
				data-placement="bottom" title="Vietnamesisch"><img
					src="img/flag_vn.png" alt="Flagge Vietnam"></a></li>
		</ul>
	</nav>
			...
			<nav class="hauptmenu">
				<ul class="nav nav-pills nav-stacked">
					<li class="nav-button"><a href="neue-gruppennachricht.html"><img
							src="img/account-icons/edit.png"> Gruppennachricht
							schreiben</a></li>
					<li><a href="index.html"><img
							src="img/account-icons/home16.png"> Startseite</a></li>
					<li><a href="neue-nachrichten.html"><img
							src="img/account-icons/mail.png"> Nachrichten</a></li>
					<li class="active"><a href="kontakte.html"><img
							src="img/account-icons/address-book.png"> Kontakte</a></li>
					<li><a href="kontakte-hinzufuegen.html"><img
							src="img/account-icons/user-plus.png"> Kontakte hinzufu¨gen</a></li>
					<li><a href="kalender.html"><img
							src="img/account-icons/calendar16.png"> Kalender</a></li>
					<li><a href="einstellungen.html"><img
							src="img/account-icons/wrench-screwdriver.png">
							Einstellungen</a></li>
				</ul>
			</nav>
					...
					<div class="panel-body">
						<div class="list-group">
							<a href="#" class="list-group-item new-message-received"> <img
								src="img/account-icons/mail.png"> Franz Mustermann <span
								class="badge">2</span>
							</a> <a href="#" class="list-group-item new-message-received"> <img
								src="img/account-icons/mail.png"> Franz Mustermann <span
								class="badge">1</span>
							</a> <a href="#" class="list-group-item"> <img
								src="img/account-icons/mail.png"> Franz Mustermann
							</a> <a href="#" class="list-group-item"> <img
								src="img/account-icons/mail.png"> Franz Mustermann
							</a> <a href="#" class="list-group-item"> <img
								src="img/account-icons/mail.png"> Franz Mustermann
		...
		<section class="main-content calc-width">
			...
			<ul class="nav nav-tabs contact-tabs" id="contact-tab">
				<li class="active"><a href="#Anfragen"> <img
						src="img/account-icons/user-plus.png"> Kontaktanfragen <span
						class="badge">2</span>
				</a></li>
				<li><a href="#Lehrer"><img
						src="img/account-icons/address-book.png"> Lehrer</a></li>
				<li><a href="#Eltern"><img
						src="img/account-icons/address-book.png"> Eltern</a></li>
				<li><a href="#Sonstige"><img
						src="img/account-icons/address-book.png"> Sonstige</a></li>
			</ul>
						...
						<c:forEach items="${allCRequests}" var="crequest">
							<div class="row">
								...
								<div class="col-lg-4 col-xs-4">
									...
									<span>${crequest.getRequest().getUsertype()}</span> <span>${crequest.getMessage()}</span>
								</div>
					...
					<div class="contact-list-wrapper">
						...
						<div class="write-all">
							<button class="btn btn-primary" type="submit">
								<img src="img/account-icons/mail-pencil.png"> Nachricht an
								alle Lehrer
							</button>
						</div>
					</div>
	...
	<script src="js/neu-2013.min.js"></script>
	<script>
